...
export default class App extends React.Component {
  ...
  getWeather = (latitude, longtitude, imgUrl="") => {
    this.setState({loading: true}, async () => {
      const API_KEY = "790ef0f48cd2dab0f8f0dffd1441c578";
      const api = `http://api.openweathermap.org/data/2.5/weather?lat=${latitude}&lon=${longtitude}&appid=${API_KEY}`;
